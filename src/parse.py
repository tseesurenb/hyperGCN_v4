...
def parse_args():
    ...
    parser.add_argument('--lr_scale', type=float, default=0.1, help="the learning rate")
    parser.add_argument('--scale', type=float, default=4.0, help="the scale for edge attributes")
